...
export const branded = async (options) => {
    ...
    return (_jsxs("div", { style: {
            ...
            borderLeft: `${options?.spacing?.small ?? 36}px solid ${options?.colors?.brand ?? "darkorange"}`,
        }, children: [logo && (_jsx("img", { src: logo, width: "250" })), _jsx("h1", { style: {
